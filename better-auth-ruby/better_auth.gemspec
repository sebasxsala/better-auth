...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/better-auth/better-auth-ruby"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/better-auth/better-auth-ruby"
  spec.metadata["changelog_uri"] = "https://github.com/better-auth/better-auth-ruby/blob/main/CHANGELOG.md"
  spec.metadata["bug_tracker_uri"] = "https://github.com/better-auth/better-auth-ruby/issues"
