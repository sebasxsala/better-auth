...
Gem::Specification.new do |spec|
  ...
  spec.summary = "Optional SAML XML validation for Better Auth SSO"
  spec.description = "Adds ruby-saml backed SAML response validation for the Better Auth Ruby SSO plugin."
  ...
  spec.metadata["changelog_uri"] = "https://github.com/sebasxsala/better-auth/blob/main/packages/better_auth-saml/CHANGELOG.md"
