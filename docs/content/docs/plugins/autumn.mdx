---
title: Autumn
description: This upstream plugin is not supported by the Ruby port yet.
---

<Callout type="warn">
This upstream plugin is not supported by the Ruby port yet. The original upstream documentation is hidden below for reference and should not be treated as Better Auth Ruby behavior.
</Callout>
...
{/*
Hidden upstream content for Autumn Billing.
