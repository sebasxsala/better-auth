...
If you have any questions, feel free to open an issue on our <Link href="https://github.com/sebasxsala/better-auth/issues">GitHub repo</Link>, or join our <Link href="https://discord.gg/better-auth">Discord server</Link> for support.
