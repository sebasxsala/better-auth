...
For other properties, you can check the <Link href="https://github.com/bekacru/better-call">Better Call</Link> documentation and the <Link href="https://github.com/sebasxala/better-off/blob/canary/packages/better-auth/src/context/create-context.ts">source code </Link>.
