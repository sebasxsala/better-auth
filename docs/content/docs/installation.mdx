...
Frontend apps should use the upstream Better Auth JavaScript client and point it
at the Ruby server.
...
{/* Upstream TypeScript installation guide is preserved in upstream/docs/content/docs/installation.mdx. */}
