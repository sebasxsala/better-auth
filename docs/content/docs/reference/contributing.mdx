...
- Take a look at our existing <Link href="https://github.com/sebasxala/better-off/issues">issues</Link> and <Link href="https://github.com/sebasxala/better-off/pulls">pull requests</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/sebasxala/better-off
...
<Steps>
    <Step>
        ...
        git remote add upstream https://github.com/sebasxala/better-off.git
...
- Check our [GitHub issues](https://github.com/sebasxala/better-off/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/sebasxala/better-off/issues">issue</Link> with questions
