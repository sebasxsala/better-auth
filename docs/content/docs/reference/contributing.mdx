...
{/*
Hidden upstream content for Contributing to BetterAuth.
...
- Take a look at our existing <Link href="https://github.com/sebasxsala/better-auth/issues">issues</Link> and <Link href="https://github.com/sebasxsala/better-auth/pulls">pull requests</Link>
...
<Steps>
    ...
    <Step>
        ...
        Visit https://github.com/sebasxsala/better-auth
...
<Steps>
    <Step>
        ...
        git remote add upstream https://github.com/sebasxsala/better-auth.git
...
- Check our [GitHub issues](https://github.com/sebasxsala/better-auth/issues) for tasks labeled `good first issue`
...
- Open an <Link href="https://github.com/sebasxsala/better-auth/issues">issue</Link> with questions
