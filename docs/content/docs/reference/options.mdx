...
{/*
Hidden upstream content for Options.
...
List of all the available options for configuring Better Auth. See [Better Auth Options](https://github.com/sebasxsala/better-auth/blob/main/packages/core/src/types/init-options.ts).
