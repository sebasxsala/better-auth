...
List of all the available options for configuring Better Auth. See [Better Auth Options](https://github.com/sebasxala/better-off/blob/main/packages/core/src/types/init-options.ts).
