...
{/*
Hidden upstream content for Security.
...
If you discover a security vulnerability in Better Auth, please report it to us at [security@openparcel.dev](mailto:security@openparcel.dev). We address all reports promptly, and credits will be given for validated discoveries.
