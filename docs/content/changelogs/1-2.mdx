...
A lot of fixes and refinements to make everything smoother, faster, and more reliable. Check out the [changelog](https://github.com/sebasxsala/better-auth/releases/tag/v1.2.0) for more details.
