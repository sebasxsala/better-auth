...
A lot of fixes and refinements to make everything smoother, faster, and more reliable. Check out the [changelog](https://github.com/sebasxala/better-off/releases/tag/v1.2.0) for more details.
